...
public enum TxCodeEnume {
    ...
    COMMON_CUSTOM_EXCEPTION(10000, "自定义"),
    ...
    COMMON_REQUEST_METHOD_EXCEPTION(10010,"请求方法异常"),
    ...
    USER_ALEARDY_IS_FRIEND_EXCEPTION(12002,"你们已经是好友啦！"),

    USER_REPEAT_APPLY_EXCEPTION(12004,"你已经申请过了！"),

    USER_PWD_ERROR_EXCEPTION(12003,"密码错误");
